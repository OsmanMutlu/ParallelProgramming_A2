	       ...
	       const double M1,const double  M2, const double b)
{
  int i, j; 
    ...
    // This is where the mumbo jumbo happens!
    // We only need to do overlapping scatter (consider ghost cells) for E_prev
     ...
     *     next timtestep
     */
    // This part does not require ghost cell bullshit!
    for (j=1; j<=m; j++){
      for (i=1; i<=n; i++)
